...
export default function UserMetaCard() {
  ...
  // O cadastro de usuário ainda só possui nome e e-mail. Os demais campos
  // (foto, cargo, localização, telefone, bio, redes sociais) ficam ocultos
  // com a classe `hidden` até o cadastro evoluir.
  ...
  const handleSave = async () => {
    ...
    if (!trimmedName) {
      setAlert({
        ...
        message: "Informe seu nome completo para continuar.",
      });
      return;
    }
    ...
    try {
      // O e-mail é único e não pode ser alterado: apenas o nome é enviado.
      const { user: updatedUser } = await apiClient.patch(
        `/auth/users/${sessionUser.id}`,
        { name: trimmedName },
      );
      updateSessionUser({ ...sessionUser, ...updatedUser });
      closeModal();
      setAlert({
        variant: "success",
            ...
            <div className="mb-4 flex flex-col gap-5 sm:flex-row lg:mb-6 xl:items-center xl:justify-between">
              <div className="flex w-full flex-col items-start gap-4 sm:flex-row sm:items-center lg:gap-6">
                <div className="text-start">
                  ...
                  <div className="hidden items-center gap-1 sm:gap-3">
            ...
            <div className="custom-scrollbar max-h-[450px] overflow-y-auto px-2 pb-3">
              ...
              <div className="hidden">
                ...
                <div className="mb-6 flex max-w-sm items-center gap-6 lg:pe-5">
                  ...
                  <div>
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      Envie uma imagem quadrada (200×200 px) em JPEG ou PNG.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="hidden">
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  <div>
                    ...
                    <Input type="text" defaultValue={user.social.facebook} />
                  </div>

                  <div>
                    <Label>X.com</Label>
                    <Input type="text" defaultValue={user.social.x} />
                  </div>

                  <div>
                    <Label>Linkedin</Label>
                    <Input type="text" defaultValue={user.social.linkedin} />
                  </div>

                  <div>
                    <Label>Instagram</Label>
                    <Input type="text" defaultValue={user.social.instagram} />
                  </div>
                </div>
              </div>
            </div>
