...
export default function FeedbackModal({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} className="max-w-150 p-5 lg:p-10">
      <div className="text-center">
        <div className="relative z-1 mb-7 flex items-center justify-center">
          ...
          >
            <path d={SHAPE_PATH} fill="" fillOpacity="" />
          </svg>
        ...
        <div className="mt-7 flex w-full items-center justify-center gap-3">
          <button
            ...
            className={`flex w-full justify-center rounded-lg px-4 py-3 text-sm font-medium text-white shadow-theme-xs sm:w-auto ${styles.button}`}
          >
            {confirmText}
          </button>
        </div>
