    ...
    <div className="w-full" ref={dropdownRef}>
      ...
      <div className="relative z-20 inline-block w-full">
        <div className="relative flex flex-col items-center">
          ...
          {isOpen && (
            <div
              className="max-h-select absolute inset-s-0 top-full z-40 w-full overflow-y-auto rounded-lg bg-white shadow-sm dark:bg-gray-900"
            ...
            >
              {options.map((option, index) => {
                ...
                return (
                  <div
                    key={option.value}
                    className={`hover:bg-primary/5 w-full cursor-pointer rounded-t border-b border-gray-200 dark:border-gray-800 ${isFocused ? "bg-primary/5" : ""} ${isSelected ? "bg-primary/10" : ""}`}
